...
```
cd existing_repo
git remote add origin https://gitlab.edl.com.la/khamla/edl-master-nextjs.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.edl.com.la/khamla/edl-master-nextjs/-/settings/integrations)
